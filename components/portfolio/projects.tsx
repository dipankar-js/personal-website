      ...
      <div className="page-container py-[60px]">
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          {projects.map((project) => (
            <article key={project.name} className="overflow-hidden rounded-[5px] border border-border bg-white transition duration-200 hover:-translate-y-[3px] hover:border-accent hover:shadow-[0_10px_30px_-18px_rgba(22,24,29,0.45)]">
